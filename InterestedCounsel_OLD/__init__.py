...
class SeiteFragenAnDenEntscheider(Page):
    # timeout_seconds = Constants.timeOutSeconds
    form_model = 'player'
    # FRAGE 7 steht auf der Form unter der Nummer 4) !!!!!!!!!!!!!!!!!! Die anderen verschieben sich um eine Frage4 ist also 5) usw.
    form_fields = ["Frage1A", "Frage1B", "Frage1C", "Frage1D","Frage1E", "Frage1F", "Frage2", "Frage3", "Frage4", "Frage5", "Frage61", "Frage62e", "Frage63", "Frage7"]
...
page_sequence = [Intro, SeiteFuerDenBerater, WarteAufDenBerater, SeiteFuerDenEntscheider, WarteAufDenEntscheider, SeiteFuerDieOpfer, WarteAufDieOpfer, SeiteFragenAnDenBerater, SeiteFragenAnDenEntscheider, AuszahlungUmfrage, ErgebnisInterestedCounsel]